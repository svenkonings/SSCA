...
/**
  ...
  */
class ValidatorNObject(path: String, repoUser: String, repoName: String, branch: String, labels: List[String], instances: Int, threads: Int, metrics: List[Metric], outputName: String = "fullOutput", collectDate: Date)
  extends ValidatorN(path, repoUser, repoName, branch, labels, instances, threads, metrics, outputName, collectDate: Date){
